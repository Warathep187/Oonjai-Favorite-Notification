...
export default withRouter(
    class GeneralUserNav extends Component {
        render() {
            return (
                <Navbar>
                    <Container>
                        ...
                        <Nav className="ms-auto">
                            <Nav.Item className="me-3">
                                <Link style={{ textDecoration: "none", color: "lightgray" }} href="/attention">
                                    <div style={{ display: "inline" }}>
                                        <img
                                            style={{ width: "28px", marginRight: "5px" }}
                                            src="/profile_images/general_user.png"
                                        />
                            ...
                            <Nav.Item className="me-3">
                                <Link style={{ textDecoration: "none", color: "lightgray" }} href="/questions/create">
                                    ถามคำถาม
                                </Link>
                            </Nav.Item>
                            <Nav.Item className="me-3">
